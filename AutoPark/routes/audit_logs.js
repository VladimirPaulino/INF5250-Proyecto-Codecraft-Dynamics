...
const AuditLogService = require('../classes/AuditLogService')
...
module.exports = (db) => {
  ...
  router.post('/', handle(async (req, res) => {
    ...
    createdResponse(res, 'Audit log created successfully', id)
  }))

  router.delete('/:id', handle(async (req, res) => {
    await service.delete(req.params.id)
    messageResponse(res, 'Audit log deleted successfully')
  }))

  router.put('/:id', handle(async (req, res) => {
    await service.updateFromBody(req.params.id, req.body)
    messageResponse(res, 'Audit log updated successfully')
  }))
